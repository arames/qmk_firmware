...
#define RS(KC) RSFT_T(KC)
   [BASE] = LAYOUT_moonlander(
       ...
       _______, _______ , _______ , _______     , _______       , _______,                       _______, _______        , _______, _______, _______     , _______,
       DF(0)  , _______ , _______ , _______     , _______       ,          TT(FN) ,     _______,          _______        , _______, _______ , _______    , _______,
    ...
    */
    [FUNCTION] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, _______, _______,     RGB_RMOD, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,          _______,     _______ ,          _______, _______, _______, _______, _______,
                                            _______, _______, _______,     _______ , _______, _______
    ),
